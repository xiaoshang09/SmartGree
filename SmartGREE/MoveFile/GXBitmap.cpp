...
//	::DeleteDC(objMemDC);
//	//BITMAP bm;
//	//GetObject(objMemBmp, sizeof(bm), (LPSTR)&bm);
...
void CGXBitmap::ToBmp(CImageDataPointer& objCImageDataPointer, HObject *Image)
{
	GX_VALID_BIT_LIST emValidBits = GX_BIT_0_7;
	BYTE* pBuffer = NULL;
	if (objCImageDataPointer.IsNull())
...
//		}
		...
		HObject Image1;
		GenImage1Extern(Image, "byte", (HTuple)m_nImageWidth, (HTuple)m_nImageHeight, (Hlong)pPBuffer, NULL);
...
//    QString wlpstr1 = QString::fromStdString( strFilePath );
